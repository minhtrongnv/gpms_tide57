...
typedef struct tile57_mariner {
    ...
    bool dense_soundings; /* host opt-in: relax spot SOUNDG SCAMIN only to
                         * the source cell's navigational-band floor, matching
                         * the older/demo progressive sounding density without
                         * ungating other chart features. Default false.
                         * Appended for ABI-append-safety. */
} tile57_mariner;
