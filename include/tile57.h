...
typedef struct tile57_mariner {
    ...
    bool dense_soundings; /* DEPRECATED ABI padding from a short-lived host
                         * experiment. Ignored by the engine. Kept only so the
                         * appended C struct layout remains compatible. */
} tile57_mariner;
